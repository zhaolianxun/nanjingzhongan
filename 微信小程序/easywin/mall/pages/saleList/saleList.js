...
Page({
  ...
  lastPage: function (toPageNo) {
    ...
    wx.request({
      url: 'https://passion.njshangka.com/easywin/m/e/mlc/rewardrecord/ent',
      method: "POST",
      data: {
      ...
      success: function (res) {
        if (res.data.code == 0) {
          ...
          for (var i = 0; i < that.data.list.length; i++) {
            happenTime = that.data.list[i].happenTime
            that.data.list[i].happenTime = that.dateChange(happenTime)
          }
