package cszyylxm.module.plat.api.pc;
...
@Controller("plat.api.pc.HomeEntrance")
@RequestMapping(value = "/p/p/homee")
public class HomeEntrance {
	...
	public void home(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			pst = connection.prepareStatement(
					"select id,gift_cover,gift_name,pay_price from t_activity where buy_way=1 limit 0,10");
			rs = pst.executeQuery();
