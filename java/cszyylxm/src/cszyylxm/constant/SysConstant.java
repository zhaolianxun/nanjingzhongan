...
public class SysConstant {
	...
	// 错误码
	public static String errorCodeCnMapperPath = "cszyylxm/config/errorCode_CN.properties";
	public static String errorCodeEnMapperPath = "cszyylxm/config/errorCode_EN.properties";
	...
	public static String ali_open_app_cszyylxm_appkey;
	public static String ali_open_app_cszyylxm_appsecret;
