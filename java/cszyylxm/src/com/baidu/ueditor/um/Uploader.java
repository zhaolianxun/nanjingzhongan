...
public class Uploader {
	...
	public void upload() throws Exception {
		...
		String subPath = this.getFolder(SysConstant.project_ossroot);
		String savePath = SysConstant.project_ossroot + subPath;
		...
		try {
			...
			while (fii.hasNext()) {
				...
				if (!fis.isFormField()) {
					...
					this.url = "http://" + SysConstant.project_domain + "/oss/" + SysConstant.project_name + subPath
							+ "/" + this.fileName;
	...
	public void uploadBase64(String fieldName) {
		String subpath = this.getFolder(this.savePath);
		String savePath = SysConstant.project_ossroot + subpath;
		String base64Data = this.request.getParameter(fieldName);
		this.fileName = this.getName("test.png");
		this.url = SysConstant.project_rooturl + subpath + "/" + this.fileName;
	...
	private String getFolder(String path) {
		...
		String subpath = "/" + formater.format(new Date());
		// this.getPhysicalPath(path + subpath)
