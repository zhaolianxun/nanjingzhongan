...
public class SecurityPayNotify {
	private Logger logger = Logger.getLogger(SecurityPayNotify.class);
	...
	public SecurityPayNotify toBean(Map<String, String> map)
	...
	public SecurityPayNotify toBean(HttpServletRequest request)
			throws ParseException {
		Map<String, String> map = new HashMap<String, String>();
