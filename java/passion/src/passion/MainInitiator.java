...
import passion.util.PassionDataSource;
...
//			Security.addProvider(new BouncyCastleProvider());
			PropertyConfigurator.configure(
					MainInitiator.class.getClassLoader().getResourceAsStream("passion/config/mainConfig.properties"));
			logger.info("-------初始化passion项目-------");
			logger.info("【系统常量初始化】");
			initConstant();
			...
			PassionDataSource.setupDataSource(SysConstant.jdbc_driver, SysConstant.jdbc_url, SysConstant.jdbc_username,
					SysConstant.jdbc_password);
			logger.info("-------初始化passion项目结束-------");
		} catch (Exception e) {
	...
	private void initConstant() throws UnsupportedEncodingException, IOException {
		InputStream in = MainInitiator.class.getClassLoader()
				.getResourceAsStream("passion/config/mainConfig.properties");
		...
		SysConstant.project_domain = properties.getProperty("project.domain");
		SysConstant.project_rootpath = properties.getProperty("project.rootpath");
		SysConstant.project_rooturl = properties.getProperty("project.rooturl");
