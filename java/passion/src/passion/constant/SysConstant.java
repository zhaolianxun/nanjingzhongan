...
public class SysConstant {
	...
	public static String project_domain = null;
	public static String project_rooturl = null;
	public static String project_rootpath = null;
	...
	// 错误码
	public static String errorCodeCnMapperPath = "passion/config/errorCode_CN.properties";
	public static String errorCodeEnMapperPath = "passion/config/errorCode_EN.properties";
