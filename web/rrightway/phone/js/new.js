...
$(function () {
    ...
    /**加载中特效**/
    var appstr = '<div id="loadings"><i></i>加载中</div><a id="backtop" href="javascript:" data="body"><img src="image/blankbg.gif" /></a>';
    $("body").append(appstr);
   ...
   //顶部右键菜单
    if ($(".popmenu").length > 0) {
        $("body").append('<div class="pop_content"><div class="pop_menu_list alltrans"><b class="rotate45"></b><a href="/index.html" class="first"><i><img src="image/right_nav1.png" /></i>首页</a><a href="/type/index.aspx"><i><img src="image/right_nav2.png" /></i>分类</a><a href="/invite/index.aspx"><i><img src="image/right_nav3.png" /></i>推广</a><a href="/search/index.aspx"><i><img src="image/right_nav4.png" /></i>搜索</a><a href="/user/index.aspx"><i><img src="image/right_nav5.png" /></i>我的</a></div></div>');
   ...
   //底部悬浮菜单
    if ($(".footer").length > 0) {
        ...
        if ($(crentobj).length > 0)
            $(crentobj).eq(0).attr("src", "/image/" + $(crentobj).eq(0).attr("data") + ".png");
   }
