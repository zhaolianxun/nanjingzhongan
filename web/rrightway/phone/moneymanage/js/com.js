...
$(function () {
    ...
    //通用内容
	var comstr = '<div class="post-func post-func-6" id="post_more_btn"><ul id="circle_box"><li><a href="javascript:;" class="i-top"><span>顶部</span></a></li><li><a href="http://wpa.b.qq.com/cgi/wpa.php?ln=1&key=' + kfqq + '" target="_blank" class="i-next i-off"><span>客服</span></a></li><li><a href="/search/index.aspx" class="i-last i-off"><span style="transform: rotate(-120deg);">搜索</span></a></li><li><a href="/user/index.aspx?r=' + Math.random() + '" class="i-tail"><span style="transform: rotate(-180deg);">我的左左街</span></a></li><li><a href="/invite/index.aspx" class="i-fav"><span style="transform: rotate(-240deg);">推广</span></a></li><li><a href="/index.aspx" class="i-see"><span style="transform: rotate(-300deg);">首页</span></a></li></ul><div class="i-close" id="post_close_btn"></div></div><div class="post-func-close"></div>';
	$("body").append(comstr);
