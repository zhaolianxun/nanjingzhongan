...
$(function () {
    ...
    //通用内容
	var comstr = '<div class="post-func post-func-6" id="post_more_btn"><ul id="circle_box"><li><a href="javascript:;" class="i-top"><span>顶部</span></a></li><li><a href="mqqwpa://im/chat?chat_type=wpa&uin=413038044&version=1&src_type=web&web_src=oicqzone.com" target="_blank" class="i-next i-off"><span>客服</span></a></li><li><a href="../search.html" class="i-last i-off"><span style="transform: rotate(-120deg);">搜索</span></a></li><li><a href="../myIndexGuest.html" class="i-tail"><span style="transform: rotate(-180deg);">我的左左街</span></a></li><li><a href="../popularize.html" class="i-fav"><span style="transform: rotate(-240deg);">推广</span></a></li><li><a href="../phoneIndex.html" class="i-see"><span style="transform: rotate(-300deg);">首页</span></a></li></ul><div class="i-close" id="post_close_btn"></div></div><div class="post-func-close"></div>';
	$("body").append(comstr);
