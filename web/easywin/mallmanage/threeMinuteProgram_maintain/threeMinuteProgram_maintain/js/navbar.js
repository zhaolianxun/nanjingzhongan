...
layui.define(['element', 'common'], function(exports) {
	...
	function getHtml(data) {
		var ulHtml = '<ul id="navbar" class="layui-nav layui-nav-tree beg-navbar">';
		for(var i = 0; i < data.length; i++) {
            if(data[i].display){
                ...
                if(data[i].spread) {
                    ulHtml += '<li class="layui-hide layui-nav-item layui-nav-itemed">';
                } else {
                    ulHtml += '<li class="layui-hide layui-nav-item">';
                }
            }*/
