...
import com.mootop.alipay.mobilepay.sign.MD5;
import com.mootop.alipay.mobilepay.sign.RSA;
...
public class AlipaySubmit {
	...
	private Logger logger = Logger.getLogger(AlipaySubmit.class);
	/**
	...
	public String buildRequest(Map<String, String> sParaTemp, String strMethod,
		...
		sbHtml.append("<form id=\"alipaysubmit\" onsubmit=\"document.charset='"
				+ alipayConfig.input_charset + "';\" accept-charset=\""
				+ alipayConfig.input_charset
				+ "\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
	...
	//	 */
	//	public  String createAppLinkString(MobilePayAbstractRequest req)
	//			throws UnsupportedEncodingException, ParseException {
	//		Map<String, String> sPara = buildRequestPara(req.toMap());
