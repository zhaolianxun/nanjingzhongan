 ...
 *
 */
public class SecurityPayService {
	 ...
	 * @throws IOException 
	 */
	public boolean asyncNotifyProcess(SecurityPayNotify notify,
			SecurityPayNotifyProcessor processor) throws IOException,
			JAXBException {
	...
	private boolean asyncNotifyVerify(SecurityPayNotify notify) {
	 ...
	 * @return
	 */
	public String genAppRequestString(String outTradeNo, String subject,
			BigDecimal totalFee, String body, String notifyUrl)
			throws UnsupportedEncodingException {
		SecurityPayRequest request = new SecurityPayRequest(notifyUrl,
				outTradeNo, subject, totalFee, body, config);
		Map<String, String> sPara = submit.buildRequestPara(request.toMap());
